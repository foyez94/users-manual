...
public class Config {
    ...
    public static final String API_KEY = "rfkil;kjhgfertyuikl3456y7ujmijnb";

    //public static String BASE_URL = "https://bettipsdirectory.zlayers.com/";
    public static String BASE_URL = "https://bettipsdirectory.zlayers.com/";
    ...
    public static String PAGE_PRIVACY_POLICY = BASE_URL + "dashboard/Api/get_one_page/7/";
