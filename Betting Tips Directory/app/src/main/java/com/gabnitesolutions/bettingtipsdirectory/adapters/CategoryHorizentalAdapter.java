package com.gabnitesolutions.bettingtipsdirectory.adapters;
...
import com.gabnitesolutions.bettingtipsdirectory.fragments.SubCategoryFragment;
...
public class CategoryHorizentalAdapter extends RecyclerView.Adapter<CategoryHorizentalAdapter.CategoryHorizentalViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull CategoryHorizentalViewHolder holder, int position)
    {
        ...
        Glide.with(context)
                ...
                .apply(new RequestOptions().transforms(new CenterCrop(), new RoundedCorners(8)) //Rounded and Circle Image
