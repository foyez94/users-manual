...
import com.gabnitesolutions.bettingtipsdirectory.models.AboutModel;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    }else if (thePosition == 6) //Terms
                    {
                        ...
                        //Pass variable to fragment
                        Bundle bundle = new Bundle();
                        String theTitle = context.getString(R.string.about_app_privacy_policy);
